<template>
    <div class="failedBox">
       ...
       <div class="failed">
           ...
           <div>
               <span>审核失败原因</span><span class="font_E">{{allInfoList.audit_time}}</span>
           </div>
           <div>
               <span class="font_E">
                   {{allInfoList.message}}
        ...
        <div class="buttonBox">
            <van-button color="#699dd7" type="primary" to="baseInfo" size="large">更新资料</van-button>
